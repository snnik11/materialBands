...
const FeaturedProperties = props => {
  ...
  return (
    <div className={className} {...rest}>
      <SectionHeader
        title="The Industry Partners for Speed Networking Semester 1, 2021"
        //"Featured properties"
      ...
      <Grid container spacing={isMd ? 4 : 2}>
        ...
        <Card>
          <h1>
            Thankyou Australian Computer Society for extended your support
            through sponsorship every year.We are priviliged to have ACS as our
            sponsor partner.
          </h1>
        </Card>
